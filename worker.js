addEventListener('fetch', event => {
  ...
  async function handleRequest(request) {
    ...
    } else if (hostname === 'gfaundead.sites.yourstreamingtools.com') {
      return new Response(getGFAUnDeadHtml(), {
        headers: { 'content-type': 'text/html' }
      })
    } else if (hostname === 'auntykai.sites.yourstreamingtools.com') {
      return new Response(getAKAuntyKaiHtml(), {
        headers: { 'content-type': 'text/html' }
      })
    } else if (hostname === 'gamingforaustralia.sites.yourstreamingtools.com') {
